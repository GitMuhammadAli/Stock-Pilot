...
// import { LayoutDashboard, Warehouse, Package, Layers, BarChart2, Settings, ChevronRight, MoreHorizontal, LogOut, User } from "lucide-react"
...
//   return (
//     <aside
//       className={`bg-bg-secondary h-screen transition-all duration-300 ease-in-out z-50 flex flex-col ${
//         isOpen ? "w-64" : "w-20"
//       } fixed md:relative`}
//     >
