...
const FeatureCard: FC<FeatureCardProps> = ({ icon: Icon, title, description, delay }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="bg-[#1C2333] p-6 rounded-xl border border-[#2C3444] hover:border-[#B6F400]/30 transition-all"
    >
...
const TestimonialCard: FC<TestimonialCardProps> = ({ initial, name, role, quote, delay }) => {
  return (
    <motion.div
      ...
      transition={{ duration: 0.5, delay }}
      viewport={{ once: true }}
      className="bg-[#1C2333] p-6 rounded-xl border border-[#2C3444]"
    >
      <div className="flex items-center mb-4">
        <div className="w-12 h-12 bg-[#B6F400] rounded-full flex items-center justify-center text-[#0B0F1A] font-bold text-xl">
          {initial}
        </div>
        <div className="ml-4">
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          ...
          >
            ...
            >
              <Button
                asChild
                className="bg-[#B6F400] hover:bg-[#9ED900] text-[#0B0F1A] font-bold py-3 px-8 rounded-lg flex items-center justify-center text-lg transition-all"
              >
                <Link href="/dashboard">
                  Get Started
              ...
              <Button
                asChild
                variant="outline"
                className="border-[#2C3444] hover:border-[#B6F400] text-white font-bold py-3 px-8 rounded-lg flex items-center justify-center text-lg transition-all"
              >
      ...
      <div className="py-20 bg-[#0F1424]">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="relative bottom-0 left-0 right-0 p-4 pt-16 flex justify-center">
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.2 }}
